...
for iter in tqdm(range(maxiter)):
    ...
    # data saving
    np.save('./samples/beta_store/tem_beta_'+str(iter)+'.npy',tem_beta)
    np.save('./samples/theta_store/tem_theta_'+str(iter)+'.npy',tem_theta)
    np.save('./samples/tau_store/tem_tau_'+str(iter)+'.npy',tem_tau)
    np.save('./samples/pi_store/tem_pi_'+str(iter)+'.npy',tem_pi)
    np.save('./samples/gamma_store/tem_gamma_'+str(iter)+'.npy',tem_gamma)
    np.save('./samples/z_store/tem_z_'+str(iter)+'.npy',tem_z)
    np.save('./samples/Sigma_store/tem_Sigma_'+str(iter)+'.npy',tem_Sigma)
    np.save('./samples/sigmae_store/tem_sigmae_'+str(iter)+'.npy',tem_sigmae)
