...
# all will be saved in data form to save mem
# z_store = array(NA, c(maxiter,m,p2))
# beta_store = array(NA, c(maxiter, p2, q))
# theta_store = array(NA, c(maxiter, p2, q))
# tau_store = array(NA, c(maxiter, p2, q))
# gamma_store = array(NA, c(maxiter, q))
# pi_store = array(NA, c(maxiter, q))
# Sigma_store = array(NA, c(maxiter,p2,p2))
# sigmas_store = array(NA, c(maxiter,1))
# sigmae_store = array(NA, c(maxitera,1))
